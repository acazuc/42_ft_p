...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/05/21 15:54:07 by acazuc            #+#    #+#             */
/*   Updated: 2016/05/21 15:56:49 by acazuc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	build_host(t_env *env)
{
	...
	if (bind(env->sock_fd, (struct sockaddr*)&env->sockaddr
				, sizeof(env->sockaddr)) == -1)
		ft_exit("server: can't bind socket (port may already be used)"
				, EXIT_FAILURE);
